...
<object class="Robot" serializationversion="2">
  <prologue>
    ...
    <triggers/>
    <sub-robots>
      <sub-robot name="calledRobot"/>
      <sub-robot name="simpleBrowse"/>
    </sub-robots>
    <device-mappings/>
    <referenced-snippets/>
  ...
  <property name="transitionGraph" class="Body">
    ...
    <steps class="ArrayList">
      <object class="Transition" serializationversion="3" id="2">
        <property name="name" class="String">Call calledRobot</property>
        <property name="stepAction" class="CallRobot2Step" serializationversion="0">
          <property name="robot2Name" class="String">calledRobot</property>
      ...
      <object class="Transition" serializationversion="3" id="4">
        <property name="name" class="String">Call simpleBrowse</property>
        <property name="stepAction" class="CallRobot2Step" serializationversion="0">
          <property name="robot2Name" class="String">simpleBrowse</property>
        </property>
